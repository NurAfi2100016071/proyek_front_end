...
<div className="w-full h-16 flex items-center px-14 justify-between bg-orange-500">
  <Link to={"/"} className="text-3xl text-white font-semibold font-Montesarrat">CAMP ADVENTURE</Link>
        
        <div className="relative">
          <button
            className="hover:bg-gray-700 hover:border-2 hover:border-white hover:text-white hover:shadow-md rounded-lg bg-white font-bold text-black py-2 px-2 mr-4"
